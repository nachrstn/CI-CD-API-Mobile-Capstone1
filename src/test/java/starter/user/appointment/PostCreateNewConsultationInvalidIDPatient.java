...
public class PostCreateNewConsultationInvalidIDPatient {
    protected String url = "https://dev.reprohealth.my.id/consultations";

    @Step("I set POST create new consultation invalid ID patient")
    public String setPostCreateNewConsultationInvalidIDPatient(){
        return url;
    }

    @Step("I send POST HTTP request create new consultation invalid ID patient")
    public void sendPOSTRequestCreateNewConsultationInvalidIDPatient(){
        ...
        SerenityRest.given()
                ...
                .post(setPostCreateNewConsultationInvalidIDPatient());
    }

    @Step("I receive response code 400 create new consultation invalid ID patient")
